...
\section{UC3-Compilazione requisiti di business}
    ...
    \end{figure}
     ...
     \subsection*{Postconditions} 
        \begin{itemize}
            \item Invio dei requisiti di business\textsubscript{G} all'intelligenza artificiale.
        \end{itemize}
...
\hline
\rowcolor{LightBlue}
ROQ7& Obbligatorio & Deve essere fornita una documentazione che prova dall'interpretazione dei criteri di accettazione delle user stories\textsubscript{G} ed il codice analizzato se risultano dei test\textsubscript{G} non gestiti.\\
\hline
\end{tabular}
