...
\begin{tabular}{P{4em} P{6em} P{7em} P{7em} P{11em}} 
  \rowcolor{Blue}
    ...
    \rowcolor{LightBlue}
    2.0.0 & 20/05/2024 & Giulia Dentone & Sabrina Caniato & Correzione e revisione finale del documento.\\
    \rowcolor{LighterBlue}
    1.4.0 & 19/05/2024 & Giulia Dentone & Giovanni Moretti & Aggiunto del riepilogo dei requisiti.\\
    \rowcolor{LightBlue}
    1.3.1 & 27/04/2024 & Samuele Vignotto & Giulia Dentone & Correzione correlazione casi d'uso e tabella requisiti funzionali.\\
    \rowcolor{LighterBlue}
...
\hline
\end{tabular}
\captionof{table}{Tabella di riepilogo dei requisiti}
