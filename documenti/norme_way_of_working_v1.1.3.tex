...
\begin{tabular}{P{5em} P{5em} P{8em} P{8em} P{10em}} 
  \rowcolor{Blue}
    ...
    \rowcolor{LighterBlue}
     1.1.3& 09/02/2024 & Vignotto Samuele & Moretti Giovanni & Aggiornamento della sezione "Gestione della qualità" \\ 
    \rowcolor{LightBlue}
    1.1.2& 08/02/2024 & Vignotto Samuele & Rezzi Andrea & Aggiornamento della sezione dei processi primari\\
    \rowcolor{LighterBlue}
    1.1.1& 14/01/2024 & Caniato Sabrina & Dentone Giulia  & Aggiunta della sezione Gestione organizzativa\\
\end{tabular}
\end{center}
\newpage
\tableofcontents
