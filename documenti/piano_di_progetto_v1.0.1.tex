...
\begin{tabular}{P{5em} P{6em} P{8em} P{8em} P{10em}} 
  \rowcolor{Blue}
    ...
    \rowcolor{LighterBlue}
     1.0.0 & 10/04/2024 & Sabrina Caniato & Samuele Vigonotto & Update Analisi dei rischi tecnologici\\
    \rowcolor{LightBlue}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Durante il periodo di Analisi, il team dedica il proprio impegno all'analisi approfondita del capitolato, con particolare attenzione alla redazione della prima versione\textsubscript{G} dei documenti fondamentali, quali l'\textit{Analisi dei Requisiti}, il \textit{Piano di Qualifica} e il \textit{Piano di Progetto}. Inoltre viene migliorato anche il documento \textit{Norme Way of Working\textsubscript{G}};
    \end{itemize}
...
\begin{itemize}
    ...
    \item \custombold{Norme del Way of Working\textsubscript{G}:} Si procede con l'individuazione degli strumenti che saranno utilizzati per la stesura della documentazione e per la collaborazione. Le norme sono emanate dall'Amministratore e il rispetto di queste norme dovrà essere certificato dai verificatori. Viene quindi redatto il documento \textit{Norme Way of Working};
    ...
    \item \custombold{Analisi dei requisiti:} Utilizzando il capitolato d'appalto e attraverso incontri con il proponente, gli Analisti identificano i requisiti del sistema e redigono una prima versione\textsubscript{G} dell'\textit{Analisi dei requisiti};
...
\subsubsection{Progettazione Technology Baseline\textsubscript{G}}
...
\subsubsection{Sviluppo Proof of Concept\textsubscript{G}}
\custombold{Periodo:} dal 12/01/2024 al 7/03/2024\\
Questo periodo inizia dopo il periodo di Progettazione per la Technology Baseline\textsubscript{G} e termina con la scadenza di consegna dei documenti per la revisione di Requirements and Technology Baseline (RTB\textsubscript{G}). L'attività principale di questo periodo è la realizzazione di un Proof of Concept.
\begin{itemize}
...
\begin{itemize}
    \item \custombold{Product Baseline\textsubscript{G}:} Questa attività illustra la baseline\textsubscript{G} architetturale del prodotto attraverso i diagrammi delle classi, dimostrando la coerenza con quanto mostrato durante l'attività di Technology Baseline\textsubscript{G};
    \item \custombold{Test\textsubscript{G}:} I Programmatori scrivono i test di unità e integrazione relativi ai componenti sviluppati in questo periodo;
...
\begin{itemize}
    \item \custombold{Test\textsubscript{G}:} Oltre ai test di unità e integrazione, vengono eseguiti test di sistema;
...
\begin{figure}[h]
    \centering
    \includegraphics[width=17cm, height=10cm]{documenti/grafici/Divisione_ore_lavorative_Sviluppo_Proof_of_Concept.jpg}    \caption{Grafico divisione ore lavorative periodo di Sviluppo Proof of Concept\textsubscript{G}}
    \label{fig:POC}
\end{figure}
...
\begin{figure}[h]
    \centering
\includegraphics[width=17cm, height=10cm]{documenti/grafici/Torta_percentuali_costi_Sviluppo_Proof_of_Concept.jpg}    \caption{Grafico della divisione percentuale dei costi sostenuti nel periodo di Sviluppo Proof of Concept\textsubscript{G}}
    \label{fig:enter-label}
\end{figure}
