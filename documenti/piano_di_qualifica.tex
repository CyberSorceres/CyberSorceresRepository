...
\begin{center}
    ...
    \hline
    \rowcolor{LighterBlue}
    TU1 & Si verifica che il componente AddProjectButton venga renderizzato correttamente  &  & \\
    \hline
    \rowcolor{LightBlue}
    TU2 &  Si verifica che il componente AddProjectButton apra una casella di inserimento testuale correttamente &  & \\
    \hline
    \rowcolor{LighterBlue}
    TU3 & Si verifica che il  pulsante di chiusura del componente AddProjectButton funzioni correttamente &  & \\
    \hline
    \rowcolor{LightBlue}
    TU4 &  Si verifica che il pulsante di invio del componente AddProjectButton funzioni correttamente &  & \\
    \hline
    \rowcolor{LighterBlue}
    TU5 & Si verifica che il componente BackButton venga renderizzato correttamente &  & \\
    \hline\rowcolor{LightBlue}
    TU6 &  Si verifica che il componente BackButton funzioni correttamente &  & \\
    \hline
    \rowcolor{LighterBlue}
    TU7 & Si verifica che il componente BuisnessRequest venga renderizzato correttamente & ROF2,ROF3 & \\
    \hline\rowcolor{LightBlue}
    TU8 &  Si verifica che il componente BuisnessRequest funzioni correttamente &ROF2,ROF3  & \\
    \hline
    \rowcolor{LighterBlue}
    TU9 & Si verifica che il componente DeleteEpic venga renderizzato correttamente &  & \\
    \hline\rowcolor{LightBlue}
    TU10 &  Si verifica che il componente DeleteEpic funzioni correttamente &  & \\
    \hline
    \rowcolor{LighterBlue}
    TU11 & Si verifica che il componente DeleteUser venga renderizzato correttamente &  & \\
    \hline\rowcolor{LightBlue}
     TU12 &  Si verifica che il componente DeleteUser funzioni correttamente &  & \\
    \hline
    \rowcolor{LighterBlue}
    TU13 & Si verifica che il componente DropdownButton venga renderizzato correttamente &  & \\
    \hline\rowcolor{LightBlue}
     TU14 &  Si verifica che il componente DropdownButton funzioni correttamente & ROF14  & \\
    \hline
    \rowcolor{LighterBlue}
    TU15 & Si verifica che il componente DropdownMenuContainer venga renderizzato correttamente &ROF14   & \\
    \hline\rowcolor{LightBlue}
     TU16 &  Si verifica che il componente DropdownMenuContainer funzioni correttamente &ROF14   & \\
    \hline
    \rowcolor{LighterBlue}
    TU17 & Si verifica che il componente DropdownMenuContainer si chiuda correttamente & ROF14  & \\
...
\begin{center}
    ...
    \hline
    \rowcolor{LighterBlue}
    TU1 &Verifica che ritorna il progetto con l'ID corretto\textsubscript{G} tramite email e password & ROF1 & NI\\
    \hline
    \rowcolor{LightBlue}
...
\begin{center}
    ...
    \hline
    \rowcolor{LighterBlue}
    TA1 & Si verifica che l’applicazione sia in grado di gestire il recupero password, inviando opportunamente una mail di
reimpostazione all’utente qualora abbia perso le proprie credenziali&  & S\\
    \hline
    \rowcolor{LightBlue}
    TA2 & SI verifica che il PM possa aggiungere nuovi clienti correttamente &  & S\\
    \hline
    \rowcolor{LighterBlue}
    TA3 & Si verifica che l’applicazione sia in grado di gestire correttamente gli eventi di autenticazione dei propri tipi di utenti, inclusi login e logout & ROF13 & S\\
    \hline
    \rowcolor{LightBlue}
    TA4 & Verificare che sia possibile per l'attore Project Manager assegnare le epic/user stories a gli attori Sviluppatore & ROF14 & S\\
    \hline
    \rowcolor{LighterBlue}
    TA5 & Verificare che venga inviata una notifica all'attore Project Manager quando vengono generate le epic/user stories & RDF15 & S\\
    \hline
    \rowcolor{LightBlue}
    TS16 & Verificare che sia possibile per l'attore Project Manager richiedere la modifica di epic/user stories all'IA & ROF16 &S\\
    \hline
    \rowcolor{LighterBlue}
    TA7 & Verificare che sia possibile per l'attore Sviluppatore visualizzare l'andamento delle epic/user stories assegnate & ROF17 & S\\
    \hline
    \rowcolor{LightBlue}
    TA8 & Verificare che il plug-in\textsubscript{G} supporti i linguaggi Typescript\textsubscript{G} e Javascript\textsubscript{G} & ROF20 & SI\\
    \hline
    \rowcolor{LighterBlue}
    TA9 & Verificare che il plug-in supporti i linguaggi Kotlin\textsubscript{G} e Swift\textsubscript{G} & RDF21 & S\\
    \hline
    \end{tabular}
    \captionof{table}{Tabella dei test di sistema}
\label{tab:testSistema}
