...
\begin{tabular}{P{10em} P{13em} P{4em} P{13em}} 
    ...
    \custombold{Soluzione}\\
    \rowcolor{LighterBlue}
     omplessità nell'integrazione del plugin & Non avendo mai sviluppato un plug in è stata difficoltosa la fase di integrazione & Bassa & Focalizzarsi sull'autoapprendimento e aggiungere uno Sviluppatore a discapito di altri ruoli più marginali in quella fase  \\ 
    \rowcolor{LightBlue}
